  ...
  app.get("/admin/security/status", async (req, res) => {
    ...
    try {
      ...
      var report = securityStatus.buildReport({
        ...
        vaultKeyExists: nodeFs.existsSync(C.PATHS.VAULT_KEY),
        caKeyMode: caKeyMode,
        caSealedExists: caSealedExists,
        caPlainExists: caPlainExists,
        caExists: caExists,
        tlsKeyMode: tlsKeyMode,
        tlsSealedExists: tlsSealedExists,
        tlsPlainExists: tlsPlainExists,
        tlsCertExists: tlsCertExists,
        tlsKeyExists: tlsKeyExists,
        tlsServing: tlsServing,
        enforceMtlsStrict: enforceMtlsStrict,
        mtlsHardEnforced: mtlsHardEnforced,
        mtlsSoftEnforced: mtlsSoftEnforced,
      });
