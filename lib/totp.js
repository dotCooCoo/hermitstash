// codebase-patterns:allow-file raw-byte-literal — RFC 6238/4226 protocol-shape constants (8-byte time, 1000000 modulus, base32 5-bit groups)
// codebase-patterns:allow-file raw-time-literal — RFC 6238 30-second TOTP step is protocol-fixed
/**
 ...
 * When the SHA-1 backlog reaches zero across all operator deployments,
 * drop the legacy branch and have callers use b.auth.totp directly.
 */
