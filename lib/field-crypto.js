...
var FIELD_SCHEMA = {
  ...
  files: {
    ...
    seal: ["shareId", "originalName", "relativePath", "storagePath", "mimeType", "uploaderEmail", "encryptionKey", "bundleShareId", "expiresAt", "vaultEncapsulatedKey", "vaultIv", "vaultBatchId", "checksum"],
    derived: {
  ...
  bundles: {
    ...
    seal: ["shareId", "uploaderName", "uploaderEmail", "message", "passwordHash", "expiresAt", "finalizeTokenHash", "stashId"],
    derived: {
      shareIdHash: { from: "shareId", fn: function (v) { return v ? sha3Hash(HASH_PREFIX.SHARE_ID + v) : null; } },
      emailHash: { from: "uploaderEmail", fn: function (v) { return v ? sha3Hash(HASH_PREFIX.EMAIL + String(v).toLowerCase()) : null; } },
    },
