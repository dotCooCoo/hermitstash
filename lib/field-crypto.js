...
var FIELD_SCHEMA = {
  users: {
    ...
    seal: ["email", "pendingEmail", "displayName", "avatar", "googleId", "passwordHash", "authType", "vaultEnabled", "vaultPublicKey", "vaultStealth", "vaultMode", "vaultSeed", "totpLastStep", "totpSecret", "totpEnabled", "totpBackupCodes", "totpAlgorithm"],
