...
var FIELD_SCHEMA = {
  ...
  customer_stash: {
    ...
    // raw: accessMode (enum for conditional logic), maxFileSize, maxFiles, maxBundleSize, defaultExpiry, bundleCount, totalBytes (integers)
    seal: ["slug", "name", "title", "subtitle", "passwordHash", "allowedExtensions", "allowedEmails", "accentColor", "logoUrl", "createdBy", "enabled"],
    derived: {
