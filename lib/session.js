...
// forwarded header counts only from a declared trusted proxy. It used to be
// derived from config.rpOrigin, which is the scheme the operator NAMED rather
// than the one the browser USED: with an https rpOrigin — what passkeys require
// — a plain-HTTP visitor was sent a Secure cookie, which the browser discards,
// so every following request arrived unauthenticated with nothing to show for it.
