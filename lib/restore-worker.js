...
async function runRestore() {
  ...
  // Verify checksum
  if (b.backupCrypto.checksum(vaultEncBuf) !== vaultEntry.checksum) {
  ...
  if (dbKeyEntry) {
    ...
    if (b.backupCrypto.checksum(dbKeyBuf) !== dbKeyEntry.checksum) {
  ...
  if (dbEncEntry) {
    ...
    if (b.backupCrypto.checksum(dbEncBuf) !== dbEncEntry.checksum) {
