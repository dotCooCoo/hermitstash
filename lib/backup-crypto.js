...
// Every entry is optional: one whose `local` is absent is skipped. Both the
// sealed and plaintext forms are listed, since which exists depends on whether
// the operator opted into sealing.
var TLS_FILES = [
