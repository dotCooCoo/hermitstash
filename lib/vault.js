...
function loadKeys() {
  ...
  process.nextTick(function () {
    try { var audit = require("./audit"); audit.log(audit.ACTIONS.VAULT_KEY_GENERATED, { performedBy: "system", details: "New ML-KEM-1024 + P-384 hybrid keypair created" }); } catch (_e) { /* audit log is best-effort — key file already written + console-logged */ }
  });
  return keys;
}
