...
// the migration runs, so this wrapper still needs the legacy path to
// read that one file. The 0xE1 branch can go once no deployment can
// still be holding an unconverted db.key.enc.
