...
var _nativeHostname = Object.getOwnPropertyDescriptor(URL.prototype, "hostname").get;
var _nativeHref     = Object.getOwnPropertyDescriptor(URL.prototype, "href").get;
...
function parse(url, opts) {
  ...
  var parsedHost = _nativeHostname.call(parsed);
  if (parsedHost && !guardDomain().aceLabelsCarryPayload(parsedHost)) {
