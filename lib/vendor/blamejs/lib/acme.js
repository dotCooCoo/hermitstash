  ...
  function buildCsr(opts2) {
    ...
    if (keyType === "ec") {
      ...
      if (curve === "prime256v1" || curve === "P-256") {
        sigOidDotted = "1.2.840.10045.4.3.2";
        sigDigest    = "sha256";
      } else if (curve === "secp384r1" || curve === "P-384") {
        sigOidDotted = "1.2.840.10045.4.3.3";
        sigDigest    = "sha384";
      } else {
      ...
      sigOidDotted = "1.2.840.113549.1.1.11";
      sigDigest    = "sha256";
