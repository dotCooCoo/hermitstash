...
function create(opts) {
   ...
   * @signature sp.buildAuthnRequest({ relayState? })
   * @since     0.8.62
   *
   ...
   * @signature sp.verifyResponse(samlResponseB64, vopts)
   * @since     0.8.62
   *
 ...
 * @signature b.auth.saml.fetchMdq({ baseUrl, entityId, trustCertPem? })
 * @since     0.8.62
 * @status    stable
