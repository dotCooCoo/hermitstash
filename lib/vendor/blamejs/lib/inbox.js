...
function create(opts) {
  ...
  var messageIdMaxLen = (typeof opts.messageIdMaxLen === "number") ? opts.messageIdMaxLen : 256;
  var sourceMaxLen = (typeof opts.sourceMaxLen === "number") ? opts.sourceMaxLen : 256;
  ...
  function _rejectControlChars(value, label, field) {
    var _off = codepointClass.firstControlCharOffset(value);
    if (_off !== -1) {
      throw new InboxError("inbox/bad-receive",
