 ...
 *
 * A custom limiter is recognized by `admitConnection` and must implement the
 ...
 * reached a method it did not have. The supported way to customize part of the
 * behavior is to build `create({...})` and override what you want to change,
