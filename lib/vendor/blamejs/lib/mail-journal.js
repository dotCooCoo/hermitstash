...
var REGIME_FLOOR_MS = Object.freeze({
  "sec-17a-4":  C.TIME.days(365 * 6),
  "finra-4511": C.TIME.days(365 * 6),
  "hipaa":      C.TIME.days(365 * 6),
  "mifid-ii":   C.TIME.days(365 * 5),
  "sox":        C.TIME.days(365 * 7),
  "gdpr":       C.TIME.days(365 * 6),
...
function create(opts) {
  ...
  async function record(req) {
    ...
    if (safeBuffer.byteLengthOf(req.bodyBytes) > C.BYTES.mib(256)) {
