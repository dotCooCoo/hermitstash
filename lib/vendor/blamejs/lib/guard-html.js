...
var htmlBalance    = require("./html-balance");

var MAX_DEPTH_CAP_ISSUES = 8;
...
function _detectIssues(input, opts) {
  ...
  for (var i = 0; i < tokens.length; i += 1) {
    ...
    if (tok.type === "tag") {
      if (!Object.prototype.hasOwnProperty.call(htmlBalance.VOID_TAGS, tok.name)) {
        depth += 1;
      }
      if (depth > opts.maxTagDepth && depthCapReported < MAX_DEPTH_CAP_ISSUES) {
        depthCapReported += 1;
        report({
