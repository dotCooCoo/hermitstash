 ...
 * shape. Numbers are refused at the boundary. That refusal is the
 * framework's defense against IEEE 754 binary-fraction drift.
 *
 * @example
 ...
 * `$` glyph) are refused. Operators normalize at the call site.
 *
 * @example
 ...
 * shaped string (`"1.085"`) and never a Number. Conversion math runs
