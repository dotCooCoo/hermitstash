...
async function importPemPublicKey(pem, alg, usages) {
  var keyObj = crypto.createPublicKey(pem);
  var spkiDer = keyObj.export({ format: "der", type: "spki" });
  return webcrypto.subtle.importKey("spki", spkiDer, alg, false, usages);
}
