  ...
  try {
    if (config.auditChainEnabled) {
      ...
      if (tip && tip.rowHash != null) {
        auditArchive.upsertPurgeAnchorNeverLower(tip.monotonicCounter, tip.rowHash, "hs-audit-schema-evolution");
...
function startRetentionCleanup() {
  ...
  function cleanup() {
    return auditArchive.runExclusivePurge(function () {
      try {
        ...
        if (config.auditChainEnabled) {
          ...
          if (boundary && boundary.rowHash != null) {
            auditArchive.upsertPurgeAnchorNeverLower(boundary.monotonicCounter, boundary.rowHash, "hs-retention-cleanup");
          }
        }
