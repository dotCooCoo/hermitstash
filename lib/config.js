...
function _build() { return {
  ...
  auditIpFull: bool("AUDIT_IP_FULL", false),
  // Default OFF: client user-agent (a device/browser fingerprint, PII) is not
  // recorded. ON captures it vault-sealed for investigations.
  auditCaptureUserAgent: bool("AUDIT_CAPTURE_USER_AGENT", false),
