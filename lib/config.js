...
const config = {
  ...
  backup: {
    ...
    // to "UTC" so backup time is unambiguous regardless of where the container
    // runs — operator can override to anchor to a specific local zone.
    timezone: s("BACKUP_TIMEZONE", "UTC"),
