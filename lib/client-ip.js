...
// IPv4-mapped IPv6 address (::ffff:1.2.3.4) is folded to its dotted-quad so a
// block on 1.2.3.4 also catches it, and the inverse can't be used to evade a
// block; IPv6 is lowercased. (Full IPv6 zero-compression normalization is not
