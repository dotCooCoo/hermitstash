...
// The four codepoint policies come from the framework's frozen floor rather
// than being re-spelled here: re-declaring them is how one copy drifts when the
// floor gains a class, and the constant exists to make that impossible.
