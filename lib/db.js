...
const COLUMNS = {
  ...
  bundles: ["_id", "shareId", "shareIdHash", "uploaderName", "uploaderEmail", "expectedFiles", "receivedFiles", "skippedCount", "totalSize", "downloads", "status", "emailHash", "passwordHash", "message", "expiresAt", "finalizeTokenHash", "skippedFiles", "ownerId", "teamId", "stashId", "bundleName", "createdAt"],
