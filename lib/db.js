...
var COLUMNS = {
  users: ["_id", "googleId", "email", "displayName", "avatar", "passwordHash", "authType", "role", "status", "emailHash", "vaultEnabled", "vaultPublicKey", "vaultStealth", "vaultMode", "vaultSeed", "totpLastStep", "totpSecret", "totpEnabled", "totpBackupCodes", "totpAlgorithm", "failedLoginAttempts", "lockedUntil", "createdAt", "lastLogin"],
