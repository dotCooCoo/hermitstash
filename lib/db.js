...
const COLUMNS = {
  ...
  files: ["_id", "shareId", "shareIdHash", "bundleId", "bundleShareId", "bundleShareIdHash", "uploadedBy", "uploaderEmail", "originalName", "relativePath", "storagePath", "mimeType", "size", "downloads", "status", "encryptionKey", "expiresAt", "emailHash", "teamId", "vaultEncrypted", "vaultEncapsulatedKey", "vaultIv", "vaultBatchId", "checksum", "createdAt"],
  bundles: ["_id", "shareId", "shareIdHash", "uploaderName", "uploaderEmail", "expectedFiles", "receivedFiles", "skippedCount", "totalSize", "downloads", "status", "emailHash", "passwordHash", "message", "expiresAt", "finalizeTokenHash", "skippedFiles", "ownerId", "teamId", "stashId", "createdAt"],
