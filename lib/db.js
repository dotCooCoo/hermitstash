  ...
  _translateQuery(query) {
    ...
    for (var key in query) {
      ...
      if (lookup && typeof val === "string") {
        ...
        //
        // The guard covers every sealed column, not only those carrying a
        // derived index. A merely sealed column — authType, totpEnabled,
        // originalName — would otherwise reach the pass-through above and answer
        // wrongly without a word. Only equality and $in over a derived index are
        // answerable.
        //
        ...
        // same column, so `{vaultEnabled: false}` would match by accident of
