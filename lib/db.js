...
const COLUMNS = {
  ...
  customer_stash: ["_id", "slug", "slugHash", "name", "title", "subtitle", "accentColor", "logoUrl", "passwordHash", "maxFileSize", "maxFiles", "maxBundleSize", "defaultExpiry", "allowedExtensions", "enabled", "createdBy", "bundleCount", "totalBytes", "createdAt"],
