...
var PATHS = {
  ...
  VAULT_KEY_SEALED:            path.join(DATA_DIR, "vault.key.sealed"),
  VAULT_KEY_SEALED_TMP:        path.join(DATA_DIR, "vault.key.sealed.tmp"),
  ...
  VAULT_KEY_MIGRATION_PENDING: path.join(DATA_DIR, "vault.key.migration-pending"),
  VAULT_KEY_UNSEAL_PENDING:    path.join(DATA_DIR, "vault.key.unseal-pending"),
  ...
  CA_KEY_SEALED: (process.env.MTLS_CA_KEY || path.join(DATA_DIR, "ca.key")) + ".sealed",
  TLS_DIR:     path.join(DATA_DIR, "tls"),
  // v1.9.4 opt-in vault-sealed TLS server private key.
  TLS_KEY_SEALED: path.join(DATA_DIR, "tls", "privkey.pem.sealed"),
  ...
  API_ENCRYPT_KEYPAIR_SEALED: path.join(DATA_DIR, "api-encrypt-keypair.sealed"),
  ...
  CUSTOM_LOGO_DIR: path.join(DATA_DIR, "custom-logos"),
  STASH_LOGO_DIR:  path.join(DATA_DIR, "stash-logos"),
};
